...
class ConceptosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concepto" do
    assert_difference('Concepto.count') do
      post conceptos_url, params: { concepto: { capitulo_id: @concepto.capitulo_id, clave: @concepto.clave, description: @concepto.description } }
    end
  ...
  test "should update concepto" do
    patch concepto_url(@concepto), params: { concepto: { capitulo_id: @concepto.capitulo_id, clave: @concepto.clave, description: @concepto.description } }
