...
class PartidasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partida" do
    assert_difference('Partida.count') do
      post partidas_url, params: { partida: { clave: @partida.clave, concepto_id: @partida.concepto_id, description: @partida.description } }
    end
  ...
  test "should update partida" do
    patch partida_url(@partida), params: { partida: { clave: @partida.clave, concepto_id: @partida.concepto_id, description: @partida.description } }
